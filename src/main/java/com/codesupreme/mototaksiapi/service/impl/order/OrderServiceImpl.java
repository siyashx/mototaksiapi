package com.codesupreme.mototaksiapi.service.impl.order;

import com.codesupreme.mototaksiapi.dao.order.OrderRepository;
import com.codesupreme.mototaksiapi.dto.order.OrderDto;
    ...
    public OrderDto updateOrder(Long orderId, OrderDto orderDto) {
        ...
        if (optional.isPresent()) {
            ...
            if (orderDto.getDistance() != null) {
                orderDto.setDistance(orderDto.getDistance());
            }

            if (orderDto.getIsDisable() != null) {
                orderDto.setIsDisable(orderDto.getIsDisable());
            }
